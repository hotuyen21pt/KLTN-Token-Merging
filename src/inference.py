...
def score_aspect_terms(
    ...
    *,
    ...
    """Score each generated aspect by mean token probability given its sentence.

    Scores are not calibrated probabilities; they can rank candidates generated
    ...
    for start in range(0, len(candidates), batch_size):
        ...
        chunk_scores = mean_log_probs.exp().cpu().tolist()
        for (record_index, _, _), score in zip(chunk, chunk_scores):
